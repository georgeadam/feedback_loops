...
from .cifar10 import generate_cifar10_dataset

STATIC_DATA_TYPES = ["gaussian", "sklearn", "moons", "mimic_iii", "support2", "sklearn_noisy_update", "moons_noisy_update", "compas", "adult", "credit", "mnist", "spambase", "cifar10"]
