...
class LRETemporalDataWrapper(TemporalDataWrapper):
    def __init__(self, data, batch_size, lre_val_proportion, include_train, ddp, ddr, tvp, agg_data, tyl, uyl, next_year):
...
class LREStaticDataWrapper(StaticDataWrapper):
    def __init__(self, data, batch_size, lre_val_proportion, include_train, ddp, ddr, tvp, agg_data, num_updates):
...
class LREValidationSizeTesting(StaticDataWrapper):
...
class LRETrainDataAsValidationStatic(StaticDataWrapper):
...
class LRETrainDataAsValidationTemporal(TemporalDataWrapper):
