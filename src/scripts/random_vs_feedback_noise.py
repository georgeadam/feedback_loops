...
def train_update_loop(n_train, n_update, n_test, num_updates, num_features, data_fn, seeds):
...
def main(args):
    ...
    initial_fprs, updated_fprs_noise, updated_fprs_feedback = train_update_loop(args.n_train, args.n_update, args.n_test,
